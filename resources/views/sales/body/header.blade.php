<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            @php 
                $id = Auth::user()->id;
                $salesData = App\Models\User::find($id);   

            @endphp
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($salesData->photo)) ? url('upload/sales_images/'.$salesData->photo):url('upload/no_image.jpg') }}" class="user-img"
                        alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('sales.profile')}}"><i
                                class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('sales.change.password') }}">
                    ...
                    <li><a class="dropdown-item" href="{{ route('sales.logout') }}"><i
