				...
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<div class="mb-4 text-center">
							...
							<h4 class="logo-text">Hashtag</h4>
						</div>
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sales sign in</h3>
									</div>
									<div class="d-grid">
                        ...
                        <div class="form-body">
                            <form class="row g-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-outline-success"><i class="bx bxs-lock-open"></i><a href="{{ route('register') }}"></a> Sign up</button>
                                    </div>
                                </div>
