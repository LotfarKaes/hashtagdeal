                        ...
                        <div class="profile-nav-info ">
                            <div class="tab-style3">
                                <ul class="nav nav-tabs text-uppercase">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Description-tab" data-bs-toggle="tab" data-overviewd="{{$data->id}}" href="{{ route('sales.encounters.overview')}}">Overview</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="products-tab" data-bs-toggle="tab" data-jobid="{{$data->id}}" href="{{ route('sales.encounters.jobs')}}">Jobs</a>
                                    </li>
                                    <!-- <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="w-50">
                                    ...
                                    <div class="tab-pane fade" value="{{$data->id}}" id="Products">
                              
                                    @foreach($companiesData as $datawithid)
                                    {{$datawithid->skills}}
                                    @endforeach
