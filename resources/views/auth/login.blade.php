					...
					<div class="col mx-auto">
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="d-grid">
										...
										<span>Sign in with LinkednIn</span>	
										</a> 
                        ...
                        <div class="form-body">
                            <form class="row g-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="col-12 text-end">	<a href="authentication-forgot-password.html">Forgot Password ?</a>
                                </div>
                                <div class="col-12">
                                    <div class="d-grid">
                                ...
                                <div class="login-separater text-center mb-4"> <span>  Don't have an HashTagDeal account?  </span>
										<hr/>
									</div>

                                <div class="col-12">
                                    <div class="d-grid">
                                        <a href="{{ route('register')}}" c class="btn btn-outline-success"><i class="bx bxs-lock-open"></i>Sign up</a>
                                    </div>
                                </div>
