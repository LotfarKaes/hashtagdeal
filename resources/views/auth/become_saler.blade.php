                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Become Saler</h1>
         <p class="mb-30">Already have an Saler account? <a href="{{ route('sales.login') }}">Saler Login</a></p>
                                        </div>


 <form method="POST" action="{{ route('saler.register') }}">
            @csrf
