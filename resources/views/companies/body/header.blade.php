<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            @php 
                $id = Auth::user()->id;
                $companiesData = App\Models\User::find($id);   

            @endphp
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($companiesData->photo)) ? url('upload/companies_images/'.$companiesData->photo):url('upload/no_image.jpg') }}" class="user-img"
                        alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('companies.profile')}}"><i
                                class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('companies.change.password') }}">
                    ...
                    <li><a class="dropdown-item" href="{{ route('companies.logout') }}"><i
