			...
			<div class="border border-3 p-4 rounded">
			 ...
			 <div class="row g-3">
				...
				<select name="brand_id" class="form-select" id="inputProductType">
						...
						<option value="3">Lead Suggestions</option>
						<option value="4">Web forms</option>
						<option value="5">Chatbot</option>
						<option value="5">Live chat</option>
						<option value="5">Web visitors</option>
						<option value="5">Campaigns</option>
						<option value="5">Marketplace</option>
						<option value="5">Messaging Inbox</option>
					  </select>
				</div>
				  <div class="col-md-7">
				  <label for="inputProductType" class="form-label">Visible to</label>
					<select name="brand_id" class="form-select" id="inputProductType">
						<option></option>
						<option value="1">Item owner</option>
						<option value="2">Item owner’s visibility group</option>
						<option value="3">Item owner’s visibility group and sub-groups</option>
