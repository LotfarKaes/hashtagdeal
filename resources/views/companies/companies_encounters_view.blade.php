...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Sales encounters view1111</div>
        <div class="ps-3">
    ...
    <div class="container">
    <div class="main-body">
    <form action="{{route('companies.interested.count')}}" method="POST">
  @csrf

            <div class="row">
            @foreach($salersData as $data)
                <div class="col-lg-5">
                <input  name="salerId" value="{{$data->id}}" type="hidden"/>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="w-50">
                                        <button type="submit" class="btn btn-success px-4  border border-warning border-3 rounded-pill" name="saler_id" value="{{$data->id}}">interested</button>
                                        </div>
                                <div class="w-50">
                                <input type="submit" class="btn btn-danger rounded-pill px-4 border border-warning border-3 rounded-pill" value="Not interested" />
                                </div>
                            </div>
