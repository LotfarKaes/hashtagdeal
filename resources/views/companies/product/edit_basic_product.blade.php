...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
						<a href="{{ route('companies.basic.all.product')}}" class="fa fa-times fa-2xl"></a> 		
						</div>
					</div>
...
<div class="card">
  <div class="card-body p-4">
	  ...
	  <hr/>
<form id="myForm" method="post" action="{{ route('companies.update.basic.product') }}" enctype="multipart/form-data" >
			@csrf
           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
				...
				<textarea name="short_descp" class="form-control" id="inputProductDescription" rows="3">{{ $products->short_descp }}
				</textarea>
			  </div>
			   <div class="mb-3">
...
<div class="page-content">
	...
	<hr>
<div class="card">
<form method="post" action="{{ route('companies.update.basic.product.thambnail') }}" enctype="multipart/form-data" >
			@csrf
...
<div class="card-body">
 ...
 <form method="post" action="{{ route('companies.update.basic.product.multiimage') }}" enctype="multipart/form-data" >
			@csrf
	...
	<a href="{{ route('companies.basic.product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete" > Delete </a>	
		</td>
	</tr>
	@endforeach		 
