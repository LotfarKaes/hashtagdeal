            ...
            <div class="header-action-2">
                ...
                <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                ...
                                <li>
                                <button id="btnSearch" class="btn btn-outline-success" onclick="window.location='{{ route('companies.login') }}'" >For Companies</button>
                                </li>

                                <li>
                                <button id="btnClear" class="btn btn-outline-success" onclick="window.location='{{ route('sales.login') }}'" >For Sales</button>
                                    ...
                                    <li>
                                        <a href="#">Companies <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
...
<!-- 
    ...
    <!-- Lower Search Header  -->
    @include('frontend.body.lower_header')
    <!--Lower header-->
