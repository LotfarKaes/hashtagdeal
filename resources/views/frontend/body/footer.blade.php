                    ...
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            <div class="newsletter-content">
                                <h2 class="mb-20">
                                   Hashtag is simple like Marketing that connects. Sales that convert."<br />
                                   Results you’ll love.
                                </h2>
                                <p class="mb-45">Start You'r daily news feeds <span class="text-brand">Hasgtag deals</span></p>
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            <li><a href="{{ route('become.saler')}}">Become a Saler</a></li>
